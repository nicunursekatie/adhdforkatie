...
import { Home, ListChecks, Sparkles, CalendarClock, Settings as SettingsIcon } from 'lucide-react';
...
export function AppLayout({ children }: { children: ReactNode }) {
  return (
    <div className="flex min-h-full flex-col md:flex-row">
      {/* Sidebar (desktop) */}
      <aside className="hidden w-56 shrink-0 border-r border-gray-200 bg-white px-3 py-6 dark:border-gray-800 dark:bg-gray-900 md:block">
